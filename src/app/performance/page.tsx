...
export default function PerformancePage() {
  return (
    <Container as="div" className="pt-16 pb-24 sm:pt-20 sm:pb-32">
      <SectionHeader
        as="h1"
        id="performance"
      ...
      <div className="text-muted-foreground mx-auto mb-16 max-w-[68ch] space-y-3 text-center leading-relaxed font-light sm:text-lg">
        <p>
          This page is an engineering checklist, not a claim that this static site does all 19 of
          these things itself. Each item below states plainly whether it is live on this portfolio
          or documents production work on another system — FastEV&apos;s and SD Engage&apos;s
          Laravel APIs, Karuna Growth Suite&apos;s Express/SQLite API, and the CloudPanel/Nginx/PM2
          VPS infrastructure behind them. Nothing here is rounded up: a static, prerendered site
          genuinely has no database and nothing to load-balance, and that is stated outright rather
          than glossed over.
        </p>
        <p>
